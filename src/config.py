...
PATH_CHEVRON_ENABLED = True
PATH_CHEVRON_SPACING_M = 0.80
PATH_CHEVRON_LENGTH_M = 0.07
PATH_CHEVRON_WIDTH_M = 0.042
PATH_CHEVRON_COLOR = (0.92, 0.98, 1.0, 1.0)
PATH_CHEVRON_START_OFFSET_M = 0.35
PATH_CHEVRON_END_MARGIN_M = 0.25

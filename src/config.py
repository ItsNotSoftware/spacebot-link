...
ISS_MODULE_POINTS_YAML = "config/iss_modules.yaml"
ISS_MODULE_DETECT_PERIOD_S = 0.5
ISS_MODULE_MAX_MATCH_DISTANCE_M = 4.0
...
PATH_LINE_RIBBON_HEIGHT_M = 0.008
...
ORIENT_PREVIEW_AXIS_GUIDE_ENABLED = True
ORIENT_PREVIEW_AXIS_GUIDE_LENGTH = 0.72
ORIENT_PREVIEW_AXIS_GUIDE_THICKNESS = 3.5
ORIENT_PREVIEW_MOTION_HINT_ENABLED = True
ORIENT_PREVIEW_MOTION_HINT_MAX_OFFSET_M = 0.2
ORIENT_PREVIEW_MOTION_HINT_SPEED_THRESH_MPS = 0.02
ORIENT_PREVIEW_MOTION_HINT_REF_SPEED_MPS = 0.35
...
# Pixel origin is image center.
ISS_MAP_ROBOT_OFFSET_XY_M = (7.4, 5.5)
ISS_MAP_ROBOT_SCALE_PX_PER_M = (26.1, 24.0)
...
ABORT_BUTTON = KeyboardButton.space()
MODE_TOGGLE_BUTTON = KeyboardButton.ascii_key("t")
...
# SpaceMouse feel tuning
SPACEMOUSE_AXIS_SCALE = 1.50
SPACEMOUSE_VERTICAL_SCALE = 0.40
